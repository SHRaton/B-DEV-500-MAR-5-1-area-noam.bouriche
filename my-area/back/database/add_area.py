...
def add_area(isActive, user_id, name, description=None, reaction_1=None, reaction_2=None, reaction_3=None, reaction_4=None, reaction_5=None, reaction_6=None):
    """
    ...
    cursor.execute('''
        INSERT INTO areas (isActive, user_id, name, description, reaction_1, reaction_2, reaction_3, reaction_4, reaction_5, reaction_6)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ''', (isActive, user_id, name, description, reaction_1, reaction_2, reaction_3, reaction_4, reaction_5, reaction_6))
...
if __name__ == '__main__':
    add_area(isActive=True, user_id=1, name='Area 1', description='Traduce a message and send it to discord', reaction_1='Deepl: trad-EN=txt, reaction_2=Discord: post-message=txt')
